module Headless
  module Menu
    class ItemsComponent < ApplicationComponent
      ...
      renders_many :items,
        types: {
          tag: lambda { |arguments| tag.is_a?(String) ? tag : tag.to_s },
          button: lambda do |text = nil, **arguments|
            if text.present?
          ...
          link: lambda do |*link_arguments, **arguments|
          ...
          shortcut: lambda do |**arguments|
            Headless::MenuComponent::ShortcutComponent
          end
        }
        ...
        merge_options!({
          ...
          data: {
            ...
            action: "
              ...
              keydown.down->headless--menu#focusNextItem
              keydown.up->headless--menu#focusPreviousItem
